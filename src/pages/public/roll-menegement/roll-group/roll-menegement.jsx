...
import * as S from "../../../../styles/systemMenegement-style/roll-menegement-style";
import { roll } from "../../../../asset/test-db/roll";
import { Button } from "devextreme-react/button";
import RollDetailContainor from "./roll-menegement-detail-container";
import { excel } from "../../../../components/excel/excel";

// 권한 메인 컴포넌트 이며 권한의 기본정보는 아래 DataGrid에서 조회되고 있고 권한의 대한 추가정보는 <RollDetailContainor> 컴포넌트에서 읽어 온다.
export default function RollMenegement() {
    ...
    <Fragment>
      <S.Wrapper>
        ...
        <S.Left>
          <S.LeftContents>
            {/* 롤 디테일정보 컴포넌트*/}
            <RollDetailContainor selectedItemKeys={selectedItemKeys} />
            {/* 롤 디테일정보 컴포넌트*/}
          </S.LeftContents>
        </S.Left>
      </S.Wrapper>
